...
export function DetailScreenAfrican({navigation}) {
    ...
    return (
        ...
        source={require("../assets/hangerBox.jpg")}>
            <View style={styles.header}>
                <View>
                    <Image style={{width:600,height:160,}} resizeMode={"contain"} source={require("../assets/african.jpg")} />
                </View>
            </View>
            <Animatable.View 
            style={styles.footer}
            animation="fadeInUpBig">
                <View style={styles.nameContainer}>
                    <Text style={styles.itemName}>African Print</Text>
                ...
                <TouchableOpacity >
                        <Image style={[styles.imageView,{width:600,height:140,}]} resizeMode={"contain"} source={require("../assets/africanboy.jpg")} />
                </TouchableOpacity>

                <TouchableOpacity >
                        <Image style={[styles.imageView,{width:600,height:140,}]} resizeMode={"contain"} source={require("../assets/africanlady.jpg")} />
                </TouchableOpacity>
                </View>
            </Animatable.View>
...
export default DetailScreenAfrican;